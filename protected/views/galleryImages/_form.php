...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'medium',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'medium'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'large'); ?>
		<?php echo $form->textField($model,'large',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'large'); ?>
	</div>
